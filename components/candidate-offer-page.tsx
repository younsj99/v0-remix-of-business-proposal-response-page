...
interface CandidateOfferPageProps {
  candidate: Candidate
}

export function CandidateOfferPage({ candidate }: CandidateOfferPageProps) {
  ...
  const isContactFormValid =
    contactFormData.name.trim() !== "" && contactFormData.email.trim() !== "" && contactPrivacyConsent
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              {candidate.name}님, 제안을 검토해주셔서 감사합니다.
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed">
              {candidate.position} 포지션 ({candidate.track} 트랙)에 대한 제안입니다.
              <br />
          ...
          {/* ... existing code for inquire state ... */}
          {viewState === "inquire" && (
            <Card className="animate-in fade-in duration-500">
              <CardHeader>
                <Button variant="ghost" size="sm" onClick={handleBackToHome} className="w-fit mb-2">
